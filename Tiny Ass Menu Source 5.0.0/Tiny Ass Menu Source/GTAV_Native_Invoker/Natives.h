...
// Generated 07 May 2015 Chopped & Screwed Since Then (;
...
namespace PLAYER
{
	...
	static void GIVE_PLAYER_RAGDOLL_CONTROL(Player player, BOOL toggle) { invoke<Void>(0xC7B4D7AC, player, toggle); } // 0xC7B4D7AC
...
namespace ENTITY
{
	...
	static Vector3 GET_ENTITY_COORDS(Entity entity, BOOL isalive) { return invoke<Vector3>(0x1647F1CB, entity, isalive); } // 0x1647F1CB
...
namespace PED
{
	...
	static Vehicle* GET_VEHICLE_PED_IS_IN1(Ped pedHandle, BOOL getLastVehicle) { return invoke<Vehicle*>(0xAFE92319, pedHandle, getLastVehicle); } // 0xAFE92319
	...
	static int GET_PED_MONEY(Ped pedHandle) { return invoke<Any>(0xEB3C4C7E, pedHandle); } // 0xEB3C4C7E
	...
	static void SET_PED_COMPONENT_VARIATION1(Ped PedHandle, int componentID, int drawableID, int textureID) { invoke<Void>(0xD4F7B05C, PedHandle, componentID, drawableID, textureID); } // 0xD4F7B05C
	...
	static void SET_PED_PROP_INDEX1(Ped PedHandle, int ComponentID, int drawableID, int TextureID) { invoke<Void>(0x0829F2E2, PedHandle, ComponentID, drawableID, TextureID); } // 0x0829F2E2
	...
	static void RESET_PED_RAGDOLL_TIMER(Ped ped) { invoke<Void>(0xF2865370, ped); } // 0xF2865370
...
namespace VEHICLE
{
	...
	static void DELETE_VEHICLE(Vehicle* vehicle)/*Vehicle* vehicle*/ { invoke<Void>(0x9803AF60, vehicle); } // 0x9803AF60
	...
	static void SET_VEHICLE_EXPLODES_ON_HIGH_EXPLOSION_DAMAGE(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x38CC692B, vehicle, toggle); } // 0x38CC692B
	...
	static void SET_VEHICLE_ENGINE_CAN_DEGRADE(Vehicle vehicle, BOOL toggle1) { invoke<Void>(0x081DAC12, vehicle, toggle1); } // 0x081DAC12
	...
	static void SET_VEHICLE_CAN_BE_USED_BY_FLEEING_PEDS(Vehicle vehicle, BOOL toggle) { invoke<Void>(0x5130DB1E, vehicle, toggle); } // 0x5130DB1E
...
namespace OBJECT
{
	static Object CREATE_OBJECT(Hash ObjectHash, float XCoord, float YCoord, float ZCoord, int p4, BOOL p5, BOOL dynamic) { return invoke<Object>(0x2F7AA05C, ObjectHash, XCoord, YCoord, ZCoord, p4, p5, dynamic); } // 0x2F7AA05C
...
namespace AI
{
	...
	static void STOP_ANIM_TASK(Ped ped, char *animDictionary, char *animationName, float blendoutSpeed) { invoke<Void>(0x2B520A57, ped, animDictionary, animationName, blendoutSpeed); } // 0x2B520A57
	...
	static void SET_DRIVEBY_TASK_TARGET(Ped shootingPed, Ped targetPed, Vehicle targetVehicle, float x, float y, float z) { invoke<Void>(0xDA6A6FC1, shootingPed, targetPed, targetVehicle, x, y, z); } // 0xDA6A6FC1
	...
	static void SET_DRIVE_TASK_CRUISE_SPEED(Ped driver, float cruiseSpeed) { invoke<Void>(0x3CEC07B1, driver, cruiseSpeed); } // 0x3CEC07B1
	...
	static void TASK_START_SCENARIO_IN_PLACE(Any PlayerHandle, char* p1, Any p2, Any p3) { invoke<Void>(0xE50D6DDE, PlayerHandle, p1, p2, p3); } // 0xE50D6DDE
	...
	static BOOL IS_PED_ACTIVE_IN_SCENARIO(Ped Phandle) { return invoke<BOOL>(0x05038F1A, Phandle); } // 0x05038F1A
...
namespace CUTSCENE
{
	...
	static BOOL HAS_THIS_CUTSCENE_LOADED(char* p0) { return invoke<BOOL>(0x3C5619F2, p0); } // 0x3C5619F2
	...
	static void STOP_CUTSCENE(char* p0) { invoke<Void>(0x5EE84DC7, p0); } // 0x5EE84DC7
	...
	static void SET_CUTSCENE_PED_COMPONENT_VARIATION(char *cutsceneEntName, int p1, int p2, int p3, Hash modelHash) { invoke<Void>(0x6AF994A1, cutsceneEntName, p1, p2, p3, modelHash); } // 0x6AF994A1
	static void _0x2A56C06EBEF2B0D9(char *cutsceneEntName, Ped ped, Hash modelHash) { invoke<Void>(0x2A56C06E, cutsceneEntName, modelHash); } // 0x2A56C06E
	...
	static void _REQUEST_CUTSCENE_EX(char *cutsceneName, int SceneID, int SequenceNumber) { invoke<Void>(0xD98F656A, cutsceneName, SceneID, SequenceNumber); } // 0xD98F656A
}

namespace INTERIOR
{
	static int GET_INTERIOR_GROUP_ID(int interiorID) { return invoke<int>(0x09D6376F, interiorID); } // 0x09D6376F
	...
	static void _LOAD_INTERIOR(int interiorID) { invoke<Void>(0x3ADA414E, interiorID); } // 0x3ADA414E
	static void UNPIN_INTERIOR(Any p0) { invoke<Void>(0xFCFF792A, p0); } // 0xFCFF792A
	static BOOL IS_INTERIOR_READY(int interiorID) { return invoke<BOOL>(0xE1EF6450, interiorID); } // 0xE1EF6450
	...
	static BOOL IS_INTERIOR_DISABLED(int interiorID) { return invoke<BOOL>(0x81F34C71, interiorID); } // 0x81F34C71
	static void CAP_INTERIOR(int interiorID, BOOL toggle) { invoke<Void>(0x34E735A6, interiorID, toggle); } // 0x34E735A6
	static BOOL IS_INTERIOR_CAPPED(int interiorID) { return invoke<BOOL>(0x18B17C80, interiorID); } // 0x18B17C80
...
namespace STREAMING
{
	...
	static void _SWITCH_OUT_PLAYER_FLAG_8_SWITCHTYPE() { invoke<Void>(0x1084F2F4); } // 0x1084F2F4
	static void _0x5B1E995D() { invoke<Void>(0x5B1E995D); } // 0x5B1E995D
	static void _0x4B4B9A13() { invoke<Void>(0x4B4B9A13); } // 0x4B4B9A13
	static void _SWITCH_OUT_PLAYER_FLAG_512_SWITCHTYPE() { invoke<Void>(0x408F7148); } // 0x408F7148
	static void _SWITCH_OUT_PLAYER(Ped ped, int flags, int switchType) { invoke<Void>(0xFB4D062D, ped, flags, switchType); } // 0xFB4D062D
	static void _SWITCH_IN_PLAYER(Ped ped) { invoke<Void>(0x2349373B, ped); } // 0x2349373B
...
namespace UI
{
	...
	static void BEGIN_TEXT_COMMAND_THEFEED_POST(char* p0) { invoke<Void>(0x574EE85C, p0); } // 0x574EE85C
	static int _SET_NOTIFICATION_MESSAGE_1(char *picName1, char *picName2, BOOL flash, int iconType, char *sender, char *subject) { return invoke<int>(0xED130FA1, picName1, picName2, flash, iconType, sender, subject); } // 0xED130FA1
	static int _SET_NOTIFICATION_MESSAGE_2(char *picName1, char *picName2, BOOL flash, int iconType, char *sender, char *subject) { return invoke<int>(0xE7E3C98B, picName1, picName2, flash, iconType, sender, subject); } // 0xE7E3C98B
	...
	static void BEGIN_TEXT_COMMAND_DISPLAY_HELP(char *inputType) { invoke<Void>(0xB245FC10, inputType); } // 0xB245FC10
	static void END_TEXT_COMMAND_DISPLAY_HELP(Any p0, BOOL loop, BOOL beep, int duration) { invoke<Void>(0xB59B530D, p0, loop, beep, duration); } // 0xB59B530D
	...
	static void DISPLAY_HELP_TEXT_THIS_FRAME(char *message, BOOL p1) { invoke<Void>(0x18E3360A, message, p1); } // 0x18E3360A
	...
	static void TOGGLE_STEALTH_RADAR(BOOL toggle) { invoke<Void>(0xC68D47C4, toggle); } // 0xC68D47C4
...
namespace GRAPHICS
{
	...
	static void END_TEXT_COMMAND_SCALEFORM_STRING() { invoke<Void>(0x386CE0B8); } // 0x386CE0B8
	...
	void _PUSH_SCALEFORM_MOVIE_FUNCTION_PARAMETER_FLOAT(float value) { invoke<Void>(0x9A01FFDA); } // 0x9A01FFDA
	void _BEGIN_TEXT_COMPONENT(char *componentType) { invoke<Void>(0x3AC9CB55); } // 0x3AC9CB55
	void _END_TEXT_COMPONENT() { invoke<Void>(0x386CE0B8); } // 0x386CE0B8
	void _POP_SCALEFORM_MOVIE_FUNCTION_VOID() { invoke<Void>(0x02DBF2D7); } // 0x02DBF2D7
}
...
namespace MOBILE
{
	...
	static void GET_MOBILE_PHONE_RENDER_ID1(char* text) { invoke<Void>(0x88E4FECE, text); } // 0x88E4FECE
}
...
namespace WATER
{
	...
	static void WAVE_INTENSITY(float p0) { invoke<Void>(0xDA02F415, p0); } //0xC54A08C85AE4D410
}
...
namespace NETWORK
{
	static BOOL NETWORK_IS_SIGNED_IN() { return invoke<Any>(0xADD0B40F); } // 0xADD0B40F
	static BOOL NETWORK_IS_SIGNED_ONLINE() { return invoke<Any>(0x6E5BDCE2); } // 0x6E5BDCE2
	...
	static int NETWORK_GET_HOST_OF_SCRIPT(char *scriptName, int instanceId, int positionHash) { return invoke<Any>(0x9C95D0BB, scriptName, instanceId, positionHash); } // 0x9C95D0BB
	...
	static BOOL _NETWORK_PLAYER_IS_CHEATER(Player player) { return invoke<BOOL>(0xD265B049, player); } // 0xD265B049
